...
const { displayName, initials: displayInitial } = useUserDisplay(() => page.props.auth.user)
        ...
        >
            ...
            <div class="border-t border-sidebar-border p-4 shrink-0">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-8 h-8 rounded-full bg-sidebar-accent flex items-center justify-center shrink-0">
                        <span class="text-xs font-semibold text-sidebar-primary">
                            {{ displayInitial }}
                        </span>
                    </div>
                    <div class="min-w-0">
