...
import { Camera, CheckCircle2, User } from 'lucide-vue-next';
...
const displayName = computed(() => {
    ...
    return p ? `${p.nombre} ${p.apellido}` : 'Agente';
});
    ...
    <PanelLayout :navLinks="navLinks">
        <div class="mx-auto max-w-2xl space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Administrá tu información personal y de acceso</p>
            </div>
            ...
            <div class="flex items-center gap-5 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <div class="relative shrink-0">
                    <div class="flex h-20 w-20 items-center justify-center overflow-hidden rounded-2xl bg-primary/10 text-primary ring-2 ring-primary/15">
                        <img v-if="avatarPreview" :src="avatarPreview" alt="Foto de perfil" class="h-full w-full object-cover" />
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div class="mt-0.5 flex items-center gap-1.5">
                        <User class="h-3.5 w-3.5 shrink-0 text-neutral-400" />
                        <p class="truncate text-sm text-neutral-500 dark:text-neutral-400">Agente · {{ user.email }}</p>
                    </div>
            ...
            <Form :action="ProfileController.update.url()" method="patch" class="space-y-4" v-slot="{ errors, processing }">
                ...
                <!-- Datos personales -->
                <PersonalProfileSection :perfil="user.perfil_persona" rolNombre="agente" :errors="errors" />
