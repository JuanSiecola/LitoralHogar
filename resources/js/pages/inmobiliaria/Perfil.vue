...
<template>
    ...
    <PanelLayout :navLinks="navLinks">
        <div class="flex flex-col space-y-8 max-w-2xl">
            ...
            <p class="text-sm text-muted-foreground">Actualizá los datos de tu inmobiliaria</p>
            ...
            <div class="flex items-center gap-5">
                <div class="relative shrink-0">
                    <div
                        ...
                        <img v-if="avatarPreview" :src="avatarPreview" alt="Logo" class="h-full w-full object-cover" />
                    ...
                    <label for="avatar-input" :class="[
                        ...
                        <input id="avatar-input" type="file" accept="image/jpg,image/jpeg,image/png,image/webp"
                            class="sr-only" @change="handleAvatarChange" />
                    </label>
                </div>
                <div>
                    ...
                    <div class="mt-0.5 flex items-center gap-1.5">
                        ...
                        <p class="text-xs text-neutral-500">Inmobiliaria · {{ user.email }}</p>
                    </div>
                    <p class="mt-1 text-xs text-neutral-400">JPG, PNG o WEBP · máx. 2 MB</p>
                </div>
            </div>

            <Form :action="ProfileController.update.url()" method="patch" class="space-y-6"
                ...
                <div
                    ...
                    <div class="grid gap-1.5">
                        ...
                        <input id="email" type="email" name="email" :value="user.email"
                            placeholder="contacto@inmobiliaria.com" autocomplete="email" required :class="[
                        ...
                        <p v-if="errors.email" class="text-danger flex items-center gap-1 text-xs font-medium"
                            role="alert">
                            {{ errors.email }}
                        </p>
                    </div>
                    <div v-if="mustVerifyEmail && !user.email_verified_at"
                        class="border-warning/30 bg-warning/5 mt-4 rounded-lg border p-3">
                        ...
                        <p v-if="status === 'verification-link-sent'" class="text-success mt-1 text-xs font-medium">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span v-if="status === 'profile-updated'" class="text-success text-sm font-medium">
                        ✓ Cambios guardados
                    </span>
                </div>
            </Form>
