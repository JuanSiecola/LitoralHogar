    ...
    <PanelLayout :nav-links="navLinks">
        ...
        <div class="mb-8 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">Bienvenido de nuevo, {{ inmobiliaria?.razonSocial ?? 'Inmobiliaria' }}</p>
            </div>
        </div>
        ...
        <div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div class="rounded-xl border border-border bg-card p-6 shadow-card">
                <div class="flex items-center justify-between">
                    <p class="text-sm font-medium text-muted-foreground">Propiedades alquiladas</p>
                    <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-green-500/10">
                        <Key class="h-4 w-4 text-green-500" />
                    </div>
                </div>
                <p class="mt-3 text-3xl font-bold text-foreground">{{ propsAlquiladas }}</p>
                <p class="mt-1 text-xs text-muted-foreground">Actualmente rentadas</p>
            </div>
