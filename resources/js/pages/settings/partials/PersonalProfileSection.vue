        ...
        <div class="grid gap-form-gap">
            ...
            <div class="grid grid-cols-1 gap-form-gap md:grid-cols-2">
                ...
                <div class="grid gap-1.5">
                    <label for="cedula" class="text-sm font-medium text-neutral-700 dark:text-neutral-200">
                        Cédula
                    </label>
                    <div class="relative">
                        <CreditCard class="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-neutral-400" />
                        <input
                            id="cedula"
                            type="text"
                            name="cedula"
